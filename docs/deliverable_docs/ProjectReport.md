# In this porject we use word embeddings and machine learning models to predict Twitter sentiment using Azure Machine Learning following Team Data Science Process (TDSP)
